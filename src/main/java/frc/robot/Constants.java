...
public class Constants {
  ...
  public static final class Gripper {
    ...
    public static final MotorSubsystemConfig gripperConfig = new MotorSubsystemConfig();

    static {
      gripperConfig.name = "Gripper";
      gripperConfig.id = 18;
      gripperConfig.unitToRotorRatio = 1;
      gripperConfig.usingAbsoluteEncoder = false;
      ...
      gripperConfig
          ...
          .inverted(true)
          .closedLoop
          .pid(GRIPPER_KP, GRIPPER_KI, GRIPPER_KD);
    }
  }
  ...
  public class Arm {
    ...
    // public static final TrapezoidProfile.Constraints ANGLE_CONSTRAINTS = new
    // TrapezoidProfile.Constraints(360, 720);
  }
  ...
  public static final class Swerve {
    ...
    public static final COTSTalonFXSwerveConstants
        CHOOSEN_MODULE = // TODO: This must be tuned to specific robot
        COTSTalonFXSwerveConstants.SDS.MK4N.Falcon500(
                COTSTalonFXSwerveConstants.SDS.MK4N.driveRatios.L2PLUS);
    ...
    public static final double MAX_ANGULAR_VELOCITY =
        9.5; // TODO: This must be tuned to specific robot
    ...
    public static final class Mod3 { // TODO: This must be tuned to specific robot
      ...
      //    public static final SwerveModuleConstants constants = new
      // SwerveModuleConstants(DRIVE_MOTOR_ID,
    }
  }
}
